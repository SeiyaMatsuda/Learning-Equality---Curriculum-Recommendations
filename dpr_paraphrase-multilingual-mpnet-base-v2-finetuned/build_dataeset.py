...
class CFG:
  ...
  PRETRAINED_PATH = Path('/root/workspace/Learning_Equality/dpr_paraphrase-multilingual-mpnet-base-v2-finetuned/fold_0/epoch=1-step=434.ckpt')
...
def main():
    ...
    # topics_df = topics_df[topics_df['fold']==0]
    # content_df = content_df.iloc[:1000]
